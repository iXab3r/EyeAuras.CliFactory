...
2. the stored token during profile configure (unless explicit stdin was requested);
3. the integration-specific environment variable;
4. a masked interactive terminal prompt when a real TTY is available.
