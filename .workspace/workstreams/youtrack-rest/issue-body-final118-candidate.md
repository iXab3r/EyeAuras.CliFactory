...
- [ ] P2/P3 and supplementary v2 work move to an explicitly linked follow-up Issue before v1 closes.
  No inventory row is silently dropped. Close only after acceptance, workstream close-out,
  linked commit/PR and CI evidence, and any required pre-commit privacy review.
